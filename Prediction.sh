...
#SBATCH --job-name=Predict ### Name your job so you can distinguish between jobs
...
python3 coca_scoring_evaluation.py -filename Result_Dataset004_COCA2Dv3.csv
#python3 Scoring3D.py